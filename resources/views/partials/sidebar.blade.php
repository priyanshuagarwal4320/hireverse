<aside class="w-60 h-full overflow-y-auto bg-white border-r border-gray-200 flex-shrink-0">
    ...
    <nav class="p-4 space-y-1">
        @if(auth()->user()->role === 'admin')
            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-semibold bg-violet-50 text-violet-700">Dashboard</a>
            <p class="text-xs font-bold text-gray-400 uppercase px-3 pt-4 pb-1">Platform</p>
            <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-semibold text-gray-600 hover:bg-gray-50">Companies</a>
            <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-semibold text-gray-600 hover:bg-gray-50">Candidates</a>
            <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-semibold text-gray-600 hover:bg-gray-50">Jobs</a>
        ...
        @else
            ...
            <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-semibold text-gray-600 hover:bg-gray-50">My profile</a>
            <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-semibold text-gray-600 hover:bg-gray-50">My applications</a>
        @endif
    </nav>
