...
@section('content')
    ...
    <p class="text-gray-500 text-sm mb-6">All applications across the platform</p>
    ...
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-5 py-10 text-center text-gray-400">No applications yet.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
