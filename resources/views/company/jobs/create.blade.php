                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <x-text-input id="job_title" name="job_title" type="text" class="block mt-1 w-full"
                                placeholder="e.g. Laravel Developer" :value="old('job_title')" required x-model="title" />
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                ...
                                <select id="job_type" name="job_type" required x-model="type"
                                    ...
                                    <option value="full_time" {{ old('job_type') === 'full_time' ? 'selected' : '' }}>Full
                                        time</option>
                ...
                <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                    ...
                    <div class="p-5 space-y-3">
                        <div class="flex gap-2">
                            ...
                            <p class="text-xs text-gray-500 leading-relaxed">Clear job titles get more relevant applicants
                                than vague ones.</p>
                        </div>
                        <div class="flex gap-2">
                            <i class="fas fa-lightbulb text-amber-500 text-xs mt-0.5"></i>
                            <p class="text-xs text-gray-500 leading-relaxed">Listing a salary range increases application
                                rates significantly.</p>
                        </div>
                        <div class="flex gap-2">
                            <i class="fas fa-lightbulb text-amber-500 text-xs mt-0.5"></i>
                            <p class="text-xs text-gray-500 leading-relaxed">Be specific about required skills to reduce
